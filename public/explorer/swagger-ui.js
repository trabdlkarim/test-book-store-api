...
(function () {
    ...
    templates["main"] = template(function (
        ...
        buffer +=
            ...
            ' - <span style="font-variant: small-caps"> powered by <a target="_blank" href="http://luracast.com/products/restler/">Luracast Restler</a> and\n        <a target="_blank" href="http://swagger.wordnik.com/">Swagger UI</a></span>\n        </h4>\n    </div>\n</div>';
        return buffer;
    });
})();
...
(function () {
    ...
    templates["param_list"] = template(function (
        ...
        function program9(depth0, data) {
            ...
            buffer +=
                escapeExpression(stack1) + " (default)</option>\n            ";
            return buffer;
        }
        ...
        buffer +=
            escapeExpression(stack1) + "</tag></td>\n<td>\n    <select name='";
        foundHelper = helpers.name;
        if (foundHelper) {
            stack1 = foundHelper.call(depth0, { hash: {} });
        } else {
...
(function () {
    ...
    ResourceView = (function (_super) {
        ...
        ResourceView.prototype.addOperation = function (operation) {
            ...
            return $(".endpoints", $(this.el)).append(
                operationView.render().el
            );
        };
    ...
    OperationView = (function (_super) {
        ...
        OperationView.prototype.submitOperation = function (e) {
            ...
            if (error_free) {
                ...
                headerParams = null;
                invocationUrl = this.model.supportHeaderParams()
                ...
                if (
                    ...
                    obj.type.toLowerCase() === "put" ||
                    obj.type.toLowerCase() === "patch"
                ) {
        ...
        OperationView.prototype.showStatus = function (data) {
            ...
            try {
                if (data.responseText.length > 0) {
                    ...
                    response_body =
                        "<pre style='color:dimgrey'>[No Content]</pre>";
                }
            } catch (error) {
                response_body =
                    "<span style='color:red'>&nbsp;&nbsp;&nbsp;[unable to parse as json; raw response below]</span><br><pre>" +
                    data.responseText +
                    "</pre>";
            }
            $(".response_code", $(this.el)).html(
                "<pre>" + data.status + " " + data.statusText + "</pre>"
            );
            $(".response_body", $(this.el)).html(response_body);
            $(".response_headers", $(this.el)).html(
                "<pre>" + data.getAllResponseHeaders() + "</pre>"
            );
