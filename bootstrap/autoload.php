...
if (file_exists(BASE . '/.env')) {
    $dotenv = Dotenv\Dotenv::createUnsafeMutable(BASE);
    $dotenv->load();
}

$env = $app->detectEnvironment(getenv('APP_ENV') ?: 'local');
...
$apiResources = require_once BASE . '/routes/api.php';
ksort($apiResources);
